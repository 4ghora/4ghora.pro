...
const navLinks = [
  ...
  {
    url: "https://terminal-4ghora-pro.vercel.app/",
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" viewBox="0 -1 16 16">
    ...
    <header className="md:flex">
      ...
      >
        <div className="w-full h-full mx-auto max-w-6xl flex items-center justify-between">
          ...
          >
            4ghora
            <span className="text-marrsgreen dark:text-carrigreen">.pro</span>
          </Link>
